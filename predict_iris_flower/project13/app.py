...
st.markdown("<span style='text-align: center; font-size: 44px;font-weight: bold;'>Iris Classification using RandomForestClassifier - Metric Coders <span>", unsafe_allow_html=True)
