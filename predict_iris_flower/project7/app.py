...
st.markdown("<span style='text-align: center; font-size: 44px;font-weight: bold;'>Iris Classification using PassiveAggressiveClassifier- Metric Coders <span>", unsafe_allow_html=True)
