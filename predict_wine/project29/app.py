...
st.markdown("<span style='text-align: center; font-size: 44px;font-weight: bold;'>Wine Classification using DecisionTreeClassifier - Metric Coders <span>", unsafe_allow_html=True)
